...
class HDOB_Activator
{

    public static function activate()
    {
        if (!self::is_woocommerce_active()) {
            deactivate_plugins(plugin_basename(HDOB_PLUGIN_FILE));
            set_transient('hdob_wc_missing_notice', true, 30);
            return;
        }
        ...
        // 'hdob_db_version' option -- see hdwebmobile-wholesale-pricing or
